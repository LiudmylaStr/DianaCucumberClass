...
public class DocuportConstants {
    ...
    public static final String ERROR_MESSAGE_EMPTY_LOGIN = "Please enter your username or email address";
    public static final String ERROR_MESSAGE_EMPTY_PASSWORD = "Please enter your password";
    ...
    public static final String RESET_PASSWORD_TOEMAIL_MESSAGE = "We've sent you an email with a link to reset your password. Please check your email.";
